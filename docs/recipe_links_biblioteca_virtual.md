...
Acelerarmarca
A capa do Accelerate apresenta barras horizontais abstratas azuis e verdes que sugerem um gráfico

Nicole Forsgren PhD, Jez Humble, Gene Kim
Implementando Desenvolvimento Lean de Softwaremarca
Implementando Lean Software Development tem uma capa com uma foto de bicicletas reclinadas em frente a uma floresta de pinheiros e montanhas cobertas de neve

Mary Poppendieck, Tom Poppendieck
Kanbanmarca
A famosa capa azul do livro Kanban traz um desenho animado com uma equipe parada em frente a um quadro Kanban. A equipe está falando sobre fazer melhorias no processo

David Anderson
Kanban pessoalmarca
A capa Kanban pessoal apresenta uma roda d’água da era industrial

Jim Benson, Tonianne DeMaria Barry
O programador pragmáticomarca
A capa do livro Pragmatic Programmer tem uma superfície de madeira antiga com ferramentas manuais e recortes de madeira

David Thomas, Andrew Hunt
Preenchendo a lacuna de comunicaçãomarca
A tampa Bridging the Communication Gap apresenta uma ponte elevatória basculante de folha dupla

Gojko Adzic
Pessoasmarca
A capa de Peopleware apresenta plantas com folhas em aquarela abstratas que sugerem a forma de uma pessoa

Tom DeMarco, Tim Lister
As cinco disfunções de uma equipemarca
A capa das Cinco Disfunções de uma Equipe tem um fundo vermelho em negrito e uma pequena imagem de empresários em pé e sentados ao redor de uma mesa

Patrick Lencioni
Topologias de equipemarca
Team Topologies tem uma capa organizada como partes de um fluxograma em várias cores

Matthew Skelton, Manuel Pais
Operações Webmarca
A capa de Operações da Web apresenta uma bateria de barracudas em um profundo oceano azul-turquesa

John Allspaw, Jesse Robbins
Acompanhamento Práticomarca
Capa prática de monitoramento com ilustração em bloco de um lagarto

Mike Juliano
Engenharia de confiabilidade do localmarca
Capa da Engenharia de Confiabilidade do Site com uma ilustração em bloco de um lagarto

Betsy Beyer, Chris Jones, Jennifer Petoff, Niall Richard Murphy
Os Princípios do Fluxo de Desenvolvimento de Produtomarca
A capa do Fluxo de Princípios de Desenvolvimento de Produto apresenta uma cascata

Dom Reinertsen
Projeto para Produtomarca
A capa do projeto ao produto apresenta a ilustração de um avião

Mik Kersten
Escapando da armadilha da construçãomarca
A capa de Escape the Build Trap tem uma armadilha gigante para ursos pronta para ser fechada

Melissa Perri
Gerenciando a Fábrica de Designmarca
O gerenciamento da capa do Design Factory possui tecnologia digital de controle manual

Dom Reinertsen
A startup enxutamarca
A capa do Lean Startup apresenta um desenho circular pintado de maneira grosseira

Eric Ries
Mapeamento de Impactomarca
A capa do Impact Mapping apresenta uma disposição de pessoas e ferramentas em torno de um troféu

Gojko Adzic
Entrega Contínuamarca
A capa da Entrega Contínua tem uma pequena imagem da Ponte Forth (uma ponte ferroviária cantilever) ao pôr do sol

Jez Humilde, David Farley Engenharia de Software Modernamarca
David Farley Desenvolvimento Orientado a Testesmarca
Kent Beck Design baseado em domíniomarca
Eric Evans A Arte da Estatísticamarca
David Spiegelhalter Como fazer o mundo somarmarca

Tim Harford O objetivO

Eli Goldratt  = Teoria das Restriçõesmarca
Eli Goldratt  = Investimentos Ilimitadosmarca
Helen Beal, Bill Bensing, Jason Cox, Michael Edenzon, Caleb Queern, John Rzeszotarski, Andres Vega, John Willis, Tapabrata “Topo” Pal

A capa de Waltzing With Bears mostra um homem parecendo preocupado dançando com um grande urso - o urso lidera

Tom DeMarco, Timothy Lister
A Equação de Colaboraçãomarca
A capa da Equação de Colaboração apresenta um girassol cujas pétalas amarelas brilhantes estão caindo

Jim Benson
O Mês do Homem Míticomarca
A capa do Mythical Man Month tem uma impressão em bloco de ursos pré-históricos presos em um poço de alcatrão

Frederico P. Brooks, Jr.
DevOps nativo da nuvem com Kubernetesmarca
DevOps nativo da nuvem com Kubernetes

Justin Domingus e John Arundel
Alegria da Agilidademarca
Joy of Agility tem capa com o texto Joy of Agility: Como resolver problemas e ter sucesso mais cedo, com um coelho saltando pelo texto

Josué Kerievsky
Como medir qualquer coisamarca
Como Medir Qualquer Coisa tem na capa o texto: Encontrando o valor dos intangíveis nos negócios
