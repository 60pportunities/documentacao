...
1.Crie um marketplace de carro
2.Pegue as imagens do unsplash
3.faça funcionar o filtro da homepage
4.deixe em português br 
5.crie uma página que tenha os detalhes do carro e ao clicar no card esta página tem que abrir com os detalhes

1.Crie um delivery
2.Quando clicar no card quero ver os detalhes do restaurante
3.os detalhes do restaurante devem abrir em uma página não em um modal
...
Objetivo:
Desenvolver um aplicativo que auxilie usuários a controlar seus gastos diários, categorizando despesas e gerando relatórios financeiros mensais em PDF. O aplicativo permite que o usuário visualize a evolução financeira por meio de gráficos e relatórios detalhados, baseados em dados fictícios para simulação e teste.

Todos os campos deverão estar em Português Brasil
