...
https://docs.github.com/en/get-started/exploring-projects-on-github
     ...
     - [Hacktoberfest](https://hacktoberfest.digitalocean.com/) (especialmente em outubro)
     - [Awesome for Beginners](https://github.com/mhirschbeck/awesome-for-beginners)


Reutilização de código
Código e soluções podem, às vezes, ser reutilizados em projetos. Você resolveu um problema de escopo muito grande para um projeto? É provável que outros projetos também possam se beneficiar disso. Você pode:

Publicar como uma biblioteca independente (dependência).
Espelhe o projeto com sua funcionalidade adicionada.
Crie uma ação do GitHub para que outros possam incluir em seu fluxo de trabalho.: são scripts empacotados que automatizam tarefas em um fluxo de trabalho de desenvolvimento de software no GitHub.
 O GitHub Marketplace  conecta você a desenvolvedores que desejam estender e melhorar seus fluxos de trabalho do GitHub. Use esta plataforma para publicar ações e compartilhar aplicativos com outros usuários gratuitamente.
